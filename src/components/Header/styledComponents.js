...
export const NxtwatchHeaderLogoutbutton = styled.button`
  border: 2px solid
    ${props => (props.themecolor === 'light' ? '#3b82f6' : '#ffffff')};
  font-family: 'Roboto';
  font-size: 20px;
  font-weight: 500;
  padding-left: 12px;
...
export const ClosePopUpBg = styled.div`
  background-color: ${props =>
    props.themeColor === 'light' ? '#ffffff' : '#212121'};
  padding-top: 40px;
  padding-bottom: 40px;
...
export const PopUpButtons = styled.button`
  border: ${props =>
    props.variant === 'confirm' ? 'none' : '1px solid #ffffff'};
  ...
  border-radius: 5px;
  background-color: ${props =>
    props.$variant === 'confirm' ? '#3b82f6' : 'transparent'};
  color: ${props => (props.themecolor === 'light' ? '#3b82f6' : '#ffffff')};
`

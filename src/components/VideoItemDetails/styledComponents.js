...
export const NxtwatchVideoTitle = styled.h1`
    font-family:"Roboto";
    color: #475569;
    font-size: 22px;
    margin-top: 30px;
...
export const NxtwatchVideoDetailsItem = styled.li`
    display: flex;
    flex-direction: row;
    align-items: center;
...
export const IconsLabel = styled.label`
    font-family:"Roboto";
    font-size: 18px;
   color: ${props => {
     if (props.status === 'like') return '#3b82f6'
     if (props.status === 'disLike') return '#3b82f6'
     if (props.savedstatus) return '#3b82f6'
     return '#94a3b8'
   }};
...
export const NxtwatchVideoChannelName = styled.h1`
font-family:"Roboto";
font-size: 18px;
margin-bottom:0px;
color: ${props => (props.themecolor === 'light' ? '#475569' : '#f8fafc')};
